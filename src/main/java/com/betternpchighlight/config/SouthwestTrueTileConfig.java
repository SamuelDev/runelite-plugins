...
public interface SouthwestTrueTileConfig extends Config {
  String swTrueTileSectionName = "Southwest True Tile";
  ...
  @ConfigItem(position = 8, keyName = "swTrueTileLines", name = "South West True Tile Line Type", description = "Sets the sw true tile outline to regular, dashed, or corners only", section = swTrueTileSectionName)
