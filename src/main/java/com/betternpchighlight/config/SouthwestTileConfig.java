...
public interface SouthwestTileConfig extends Config {
  ...
  @ConfigItem(position = 8, keyName = "swTileLines", name = "South West Tile Line Type", description = "Sets the sw tile outline to regular, dashed, or corners only", section = swTileSectionName)
